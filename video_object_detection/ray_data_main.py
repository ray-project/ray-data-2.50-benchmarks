...
def run_pipeline():
    # This repro targets Ray Data 2.50, so two settings were dropped from the Ray
    # Data master version during transfer: `DataContext.isolate_read_workers` and
    # `DataContext.default_map_logical_memory_enabled`. Both were added after 2.50
